    ...
    if (input) {
        input.addEventListener('input', function (event) {
            ...
            if (flag == true) {
                ...
                window.setTimeout(() => {
                    // flag = true;
                    keyword = input.value; hienthi.innerHTML=`<div class="spinner-grow text-warning" role="status">
                            ...
                            window.onscroll = function (event) {
                                ...
                                if ((document.documentElement.offsetHeight - window.innerHeight - window.scrollY <= 200)) {
                                    ...
                                    if (co) {
                                        console.log('hihi');
                                        co = false;
                                        hienthi.innerHTML=`<div class="spinner-grow text-warning" role="status">
                                        <span class="sr-only">Loading...</span>
                                      </div>`;
